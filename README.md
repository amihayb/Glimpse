# Glimpse - Blau Robotics

**Glimpse** is a lightweight, browser-based app for visualizing and analyzing signal data from CSV or text files.
Developed by Blau Robotics, it helps you explore telemetry, compare signals, and inspect trends quickly in the browser.
We build reliable tools for advanced control systems — because at Blau Robotics, **we do it best.**

## Features

### 🔧 Core Functionality
- **CSV/Text Import**: Load data from CSV or text files
